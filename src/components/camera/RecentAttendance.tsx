        ...
        {displayRecords.length === 0 ? (
          ...
          displayRecords.map((record) => {
            ...
            <div
              ...
              className={`group flex items-center justify-between p-3 bg-base-100 hover:bg-base-50 rounded-2xl border border-base-200 shadow-sm hover:shadow-md transition-all duration-300 animate-slide-in relative overflow-hidden`}
            >
