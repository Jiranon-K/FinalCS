                      ...
                      <tr key={activity.id}>
                        <td>
                          <div className="flex items-center gap-3">
                            ...
                            <div className="text-xs opacity-50 badge badge-ghost badge-sm">
                              {activity.user?.role}
                            </div>
                          </div>
                        </td>
                        <td>
                          <span className="font-medium">
                            {activity.action === "initial"
                              ? t.faceRequests?.newImage
                              : t.faceRequests?.title}
                          </span>
                          <br />
                          <span className="text-xs opacity-70">
                            {t.faceRequests?.status}:{" "}
                            {activity.details.includes("pending")
                              ? t.faceRequests?.pending
                              : activity.details.includes("approved")
                                ? t.faceRequests?.approved
                                : activity.details.includes("rejected")
            ...
            <div className="flex flex-col gap-3 mt-4">
              ...
              >
                {exporting ? (
                  ...
                  <>
                    {t.common?.export || "Export Attendance"}
