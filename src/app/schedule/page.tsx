...
export default function SchedulePage() {
  ...
  const todaysCourses = useMemo(() => {
    return courses
      .filter((course) =>
        course.schedule.some((slot) => slot.dayOfWeek === today),
      )
      .map((course) => ({
        ...course,
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h2 className="font-bold text-lg">
                  {t.schedule.today} ({dayNames[today]})
                </h2>
                <p className="text-sm text-base-content/60">
                  {todaysCourses.length} {t.course.title}
                </p>
              </div>
            </div>
              ...
              {todaysCourses.map((course) => (
                ...
                >
                  ...
                  <span className="text-xs font-medium text-primary/80">
                    {t.attendanceManagement.manageSession}
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <div className="bg-base-200/30 rounded-2xl p-8 mb-8">
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-lg font-semibold mb-2">
                      {t.schedule.noCoursesYet}
                    </h3>
                    <p className="text-base-content/50 mb-6 max-w-sm">
                      {t.schedule.addFirstCourse}
                    </p>
